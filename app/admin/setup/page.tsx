    ...
    <div className="min-h-screen bg-[#141414] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-light text-[#f0f0f0] mt-6">Create Admin Account</h1>
          <p className="text-sm text-[#666] mt-2">Set up your admin credentials</p>
        </div>
        ...
        <p className="text-center text-[#666] text-xs mt-6">
          ...
          <Link href="/admin/login" className="text-[#c4a747] hover:text-[#d4b757]">
            Sign in
          </Link>
        </p>
      </div>
